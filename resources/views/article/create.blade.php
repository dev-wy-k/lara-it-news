            ...
            <div class="card-body">
                <div class="form-group mb-0">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="title" form="createArticle" name="title" value="{{ old('title') }}" class="form-control form-control-lg @error('title') is-invalid @enderror">
                        @error('title')
                        <small class="text-danger font-weight-bold">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" form="createArticle" id="description" rows="15" class="form-control form-control-lg @error('description') is-invalid @enderror">{{ old('description') }}</textarea>
                        @error('description')
                        <small class="text-danger font-weight-bold">{{ $message }}</small>
                        @enderror
                    </div>
