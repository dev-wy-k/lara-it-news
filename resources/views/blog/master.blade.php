...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Padauk:wght@400;700&family=Raleway:wght@100;200;300;400;700;900&display=swap" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom position-fixed top-0 w-100">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="col-12 col-lg-4 border-start d-block d-lg-none" id="sidebarColumn">
                            ...
                            <div id="search" class="mb-5">
                                <form action="" method="get">
                                    <div class="d-flex search-box">
                                        <input type="text" name="search" class="form-control flex-shrink-1 me-2 search-input" value="{{ request()->search ? request()->search : '' }}" placeholder="Search Anything" required>
    ...
    <div class="container">
        <div class="row justify-content-center g-5">
            ...
            <div class="col-12 col-lg-4 border-start d-none d-lg-block" id="sidebarColumn">
                <div class="position-sticky" style="top: 100px">
                    <div class="mb-5 sidebar">
